...
|----------|--------|---------|
| Security Audit | $30,000 | Professional, public audit of encryption stack (deniableEncryption.ts, encryption.ts) by a recognized firm |
| Tor Integration & Optimization | $20,000 | Development, deployment, and redundancy of .onion hidden service; performance tuning for low-bandwidth regions |
| Pilot Deployment & NGO Support | $25,000 | Onboarding 3–5 human rights or media partners; usability testing; safety review with security trainers |
| Applied Research & Documentation | $15,000 | White paper on deception research; multi-language guides (Arabic, Farsi, Russian); threat model updates |
| Sustainability & Ecosystem | $10,000 | Formalize "Malaysian University Collective" model; build legal/technical framework for Ghost Guardian |

### Milestones

**Month 1–3:**
- Begin independent security audit
- Finalize Tor hidden service architecture
- Onboard first pilot NGO partner

**Month 4–6:**
- Complete and publish audit report
- Launch Tor hidden service (ghostxxxxxx.onion)
- Deploy to 3–5 NGOs; collect feedback

**Month 7–12:**
- Publish deception research white paper
- Release multi-language deployment guides
- Formalize Ghost Guardian sustainability model
- Apply for follow-on funding (NLnet, Mozilla)
