...
interface DecoyAdminPanelProps {
  onTimeout: () => void;
}
 ...
 */
const DecoyAdminPanel = ({ onTimeout }: DecoyAdminPanelProps) => {
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-foreground font-mono">
                        anon_{(bestEffortRandomInt(0x1000000) + 0x1000000).toString(36).slice(1)}
                      </p>
                      <p className="text-xs text-muted-foreground">
                        Last seen: {bestEffortRandomInt(60)}m ago
                      </p>
                    </div>
                  </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <div className="h-2 bg-muted rounded-full overflow-hidden">
                    <div 
                      className="h-full bg-primary transition-all duration-500 admin-progress"
                      style={{ '--admin-progress': `${stats.cpuUsage}%` } as React.CSSProperties}
                    />
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <div className="h-2 bg-muted rounded-full overflow-hidden">
                    <div 
                      className="h-full bg-accent transition-all duration-500 admin-progress"
                      style={{ '--admin-progress': `${stats.memoryUsage}%` } as React.CSSProperties}
                    />
                  </div>
                </div>
              </motion.div>
...
export default DecoyAdminPanel;
