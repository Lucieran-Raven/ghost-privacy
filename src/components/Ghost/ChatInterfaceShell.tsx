 ...
 * ChatInterfaceShell
 *
 * Presentational/orchestration shell for secure chat UI.
 * Security-sensitive transport, media, and purge state are composed through
 * dedicated hooks under `src/components/Ghost/chat`.
 */
...
import { useAttachmentPickerGuards } from './chat/useAttachmentPickerGuards';
import { useChatTransport } from './chat/useChatTransport';
import { useMediaVoice } from './chat/useMediaVoice';
import { useQuarantine } from './chat/useQuarantine';
...
const ChatInterfaceShell = ({ sessionId, token, channelToken, isHost, timerMode, onEndSession }: ChatInterfaceProps) => {
  ...
  const { handleFilePickerGate, handleVideoPickerGate } = useAttachmentPickerGuards({
    isKeyExchangeComplete,
    verificationState,
    setVerificationState
  });
  ...
  }, [sessionId, setMemoryStats, setMessages]);
...
export default ChatInterfaceShell;
